...
public class CarTests {
	...
	public void setUp() throws Exception {
		theVehicle = new Car(VEH_ID, ARRIVAL_TIME, SMALL);
		theSecondVehicle = new Car(VEH_ID_2, ARRIVAL_TIME + 5, !SMALL);
	}
	...
	public void testCar() throws VehicleException {
		Car car = new Car(VEH_ID, ARRIVAL_TIME, SMALL);
	}	
	...
	public void testArrivalTimeZeroException() throws VehicleException{
		Car car = new Car(VEH_ID, ARRIVAL_TIME - ARRIVAL_TIME
				, SMALL);
	}
	...
	public void testArrivalTimeNegOneException() throws VehicleException{
		Car car = new Car(VEH_ID, ARRIVAL_TIME - ARRIVAL_TIME - 1,
				SMALL);
	}
	 ...
	 */
	@Test
	public void testToStringIsSmall() throws VehicleException{
		Car car = new Car(VEH_ID,ARRIVAL_TIME, !SMALL);
	...
	public void testIsSmallFalse() throws VehicleException {
		Car car = new Car(VEH_ID, ARRIVAL_TIME, !SMALL);
		assertEquals("Did not get the correct size.", !SMALL, car.isSmall());
	}
	...
	public void testIsSmallTrue() throws VehicleException {
		assertEquals("Did not get the correct size.", SMALL, theVehicle.isSmall()); 
	}

		/* Test to make sure that if there are two vehicles
		 * that they don't overwrite each others parameters 
		 */
	/**
	 * Test method for {@link asgn2Vehicles.Car#isSmall()}.
	 * @throws VehicleException 
	 */
	@Test
	public void testIsSmallMultipleVehicles(){
		assertTrue(theVehicle.isSmall() != theSecondVehicle.isSmall());
	}
